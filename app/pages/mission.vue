    ...
    <UContainer class="text-center">
        <section class="max-w-3xl mx-auto pt-12 px-4">
            ...
            <div class="flex flex-col md:flex-row items-center mb-12">
                <img src="/teamwork.webp" alt="Równość i współpraca" class="w-24 h-24 mb-4 mx-auto md:mx-0 md:mr-6">
            ...
            <div class="flex flex-col md:flex-row-reverse items-center mb-12">
                <img src="/movement.webp" alt="Dostępność" class="w-24 h-24 mb-4 mx-auto md:mx-0 md:ml-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <img src="/solidarity.webp" alt="Wszechstronny rozwój ruchowy"
            ...
            <img class="mx-auto" src="/body-trans-mini.webp">
        </section>
    </UContainer>
</template>
