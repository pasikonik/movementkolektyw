  ...
  <div class="flex flex-col justify-center items-center py-8 px-0">
    ...
    <table class="bg-white table-fixed w-full md:w-md">
      ...
      <tbody>
        <tr>
          ...
          <td
            class="py-2 px-4 text-lg bg-orange-300 border text-center"
            rowspan="6"
          >
            <div class="uppercase font-bold">Movement</div>
            <div>18:45-20:15</div>
          </td>
          <td class="py-2 px-4 bg-orange-100 border-b border-r text-sm">
            Rozgrzewka
          </td>
        </tr>
        ...
        <tr>
          <td class="pt-6 pl-3 bg-green-400 border-b border-l" rowspan="6">
            <div
              class="text-2xl inline-block transform origin-[75%_65%] -rotate-90 w-full h-full uppercase"
            >
              Czwartek
            </div>
          </td>
    ...
    <div class="p-10">
      ...
      <div class="flex items-center space-x-4">
        ...
        <a
          href="https://maps.app.goo.gl/rdUvGnu2DjSosHtv7"
          target="_blank"
